...
export const driverTools = {
    list_drivers: {
        description: "List drivers in your organization. Supports search by name, email, phone, or CDL number. Returns paginated results.",
    ...
    create_driver: {
        description: "Create a new driver in your organization. At minimum, first_name and last_name are required.",
    ...
    deactivate_driver: {
        description: "Deactivate (soft-delete) a driver. The driver record is retained but marked as inactive. Active consents are not affected.",

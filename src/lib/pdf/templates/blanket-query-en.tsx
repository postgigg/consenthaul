...
import { BLANKET_CONSENT_TEXT_EN } from '@/lib/constants';
...
export interface BlanketQueryEnProps {
  consent: {
    id: string;
    consent_type: string;
...
export function BlanketQueryEn({
  consent,
  driver,
  organization,
  signatureDataUrl,
  ...
  const consentBody = BLANKET_CONSENT_TEXT_EN.body(
    driver.name,
    organization.name,
    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Full Query (Blanket) Consent</Text>
        </View>
        ...
        <View style={styles.acknowledgmentBox}>
          <Text style={styles.acknowledgmentText}>
            {BLANKET_CONSENT_TEXT_EN.acknowledgment}
          </Text>
        </View>

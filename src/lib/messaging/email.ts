...
export async function sendDriverReceiptEmail({
  ...
  const t = isSpanish
    ? {
        ...
        retention: 'Su documento de consentimiento firmado será retenido por <strong>3 años</strong> según lo requiere 49 CFR § 382.703.',
    ...
    : {
        ...
        labelSigned: 'Signed',
        labelId: 'Consent ID',
        retention: 'Your signed consent document will be retained for <strong>3 years</strong> as required by 49 CFR § 382.703.',

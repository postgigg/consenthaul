...
const FAQS = [
  ...
  },
  {
    ...
    a: 'It depends on the query type. For annual limited queries (49 CFR 382.701(b)), a driver\'s general consent "may be effective for more than one year" — including the full duration of employment. Employers can collect this consent once at hire and run annual limited queries without re-collecting each year. For pre-employment full queries (382.701(a)) and violation follow-up full queries (382.701(b)(3)), the driver must provide separate electronic consent through the FMCSA Clearinghouse portal each time (382.703(b)). ConsentHaul collects the general written consent for limited queries — the most common type used for annual compliance.',
  },
];
